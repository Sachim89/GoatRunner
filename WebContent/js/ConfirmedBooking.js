$(document).ready(function() {
		...
		// Get the the values from the local storage and display in the user profile
		...
		$("#cancel").click(function() {
			...
			$.ajax({
				url : "http://localhost:8080/GoatRunner/application/ride/cancel?bookingId="+ bookid,
				type : "POST",
		...
		//Funtionalities that uses Directions API to display the route
